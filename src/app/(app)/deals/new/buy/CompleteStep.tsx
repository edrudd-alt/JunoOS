...
export function CompleteStep({ dealId: _dealId }: Props) {
  return (
    <div className="card" style={{ padding: 32, textAlign: 'center' }}>
      ...
      <div style={{ fontSize: 15, fontWeight: 500, color: '#0f2744', marginBottom: 8 }}>Complete</div>
      <div style={{ fontSize: 12, color: '#888' }}>
        Final deal completion — Juno signs docs, investments activated, valuation logged.
      </div>
    </div>
  )
}
