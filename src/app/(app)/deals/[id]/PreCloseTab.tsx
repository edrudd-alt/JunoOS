...
export function PreCloseTab({
  ...
  function calcFifoLots(clientId: string): FifoLot[] {
    ...
    const clientLots = companyInvestments
          ...
          <div style={{
            ...
            <div className="card" style={{ width: 520, padding: '24px 28px', maxHeight: '90vh', overflowY: 'auto' }}>
              ...
              <div style={{ fontSize: 12, color: '#888', marginBottom: 16 }}>
                {totalShares.toLocaleString(undefined, { maximumFractionDigits: 0 })} shares at {dealSharePrice != null ? `£${dealSharePrice.toFixed(4)}` : '—'}/share
              </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11, marginBottom: 12 }}>
                ...
                <tbody>
                  {lots.map((lot, i) => {
                    const srcLot = companyInvestments.find(inv => inv.id === lot.investmentId)
                    return (
                      <tr key={i}>
